...
const showPassword = () => {
    ...
    if(ref.current.src.includes("visible_7042918.png")){
        ref.current.src = "visibility_7042917.png"
        passwordRef.current.type = "text"

    }
    else{
        ref.current.src = "visible_7042918.png" 
...
<ToastContainer />
      <div>
        ...
        <div className=" p-2 md :px-0 mycontainer">
            <h1 className='text-4xl-text font-bold text-center'>
                ...
                <span className='text-4xl'>Pass</span><span className='text-green-700 font-bold text-4xl'>Secure/&gt;</span>
            </h1>
            ...
            <div className="flex flex-col md: flex-row w-full justify-between gap-5">
                ...
                <input ref={passwordRef} value={form.password} onChange={handleChange} placeholder='Enter password' className='rounded-full border border-green-500 w-full p-4 py-1' type="password" name="password" id="password"   />
                 <span className="absolute right-0 top-1 cursor-pointer" onClick={showPassword}>
                    <img ref={ref} className='p-1' width={23} src="visibility_7042917.png" alt="eye"/>
                 </span>
                </div>
               ...
               <button onClick={savePassword} className='flex w-fit justify-center items-center hover:bg-green-400 bg-green-600 rounded-full px-4 py-2 border-green-900 hover:border-2'>
               <lord-icon
     ...
     <tbody className='bg-green-100'>
      ...
      <td className='flex item-center justify-center py-2 border border-white text-center '>
